...
sdktest.description("Two widgets are created programmatically, once with `sdk.attach()` and another with `sdk.createWidget`");
...
const widget2 = sdk.createWidget({element: mount, sitekey});
